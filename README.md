...
## 🎥 Demo
[![PLC 기반 파이로 공정 목업 시설 Unity 디지털 트윈](https://img.youtube.com/vi/N6-VXnxK1QI/0.jpg)](https://youtu.be/N6-VXnxK1QI)
*이미지를 클릭하면 YouTube 데모 영상으로 연결됩니다.*
...
- **Laboratory Automation of Pyroprocessing Using a Digital Twin-Enabled Dry Mock-Up**, KAERI (2025).
- [VagabondK.Protocols: LS ELECTRIC FEnet Protocol Library (GitHub)](https://github.com/VagabondK/VagabondK.Protocols)
- [CoACD: Approximate Convex Decomposition for 3D Meshes (GitHub)](https://github.com/Sarah-C/CoACD)
